        ...
        <div class="form-group">
            ...
            <form action="AddPlayers" method="POST">
                ...
                <div class="row">
                    ...
                    <label for="jugador1"><span class="glyphicon glyphicon-user"></span> Portero</label>
                    <br>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                        <label for="jugador7"><span class="glyphicon glyphicon-user"></span> MCD</label>
                        <br>
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                        <label for="jugador8"><span class="glyphicon glyphicon-user"></span> EI</label>
                        <br>
                        ...
                        <div class="col-xs-4">
                        <label for="jugador9"><span class="glyphicon glyphicon-user"></span> MCO</label>
                        <br>
                        ...
                        <div class="col-xs-4">
                        <label for="jugador10"><span class="glyphicon glyphicon-user"></span> ED</label>
                        <br>
                    ...
                    <br>
                    <br>
                        <label for="jugador11"><span class="glyphicon glyphicon-user"></span> DC</label>
                        <br>
