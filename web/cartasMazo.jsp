...
<%@page import="entities.MazoCarta"%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            List<MazoCarta> mazos = (List<MazoCarta>) request.getAttribute("mazoscarta");
          %>
          <%
            for (MazoCarta mazo : mazos) {
        %>
        <h1>Listado de Cartas</h1>
        <figure class="snip1571"><img src="http://cx.comunidadxbox.com/wp-content/imagenes/FUT_Primaryhero-bg-md.jpg" alt="sample103" />
            <figcaption>
                <h3>Nombre: <%= mazo.getIdmazocarta()%><br>Media: <%= mazo.getIdmazocarta()%></h3>
            </figcaption>
            <a href="#"></a>
        </figure>   
        <% }
